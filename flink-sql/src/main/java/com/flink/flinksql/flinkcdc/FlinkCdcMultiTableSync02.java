...
import com.flink.flinksql.catalog.MysqlCatalog;
...
public class FlinkCdcMultiTableSync02 {
    ...
    // 本地运行参数
    // --connector_with_body_path /data/flink-study/sql/connector_with_body/hudi_with_body --username root --password 123456 --host 127.0.0.1 --db flinksql_test

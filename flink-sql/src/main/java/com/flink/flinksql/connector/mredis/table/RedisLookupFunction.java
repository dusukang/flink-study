...
import static com.flink.flinksql.connector.mredis.common.mapper.RedisCommand.GET;
import static com.flink.flinksql.connector.mredis.common.mapper.RedisCommand.HGET;
...
public class RedisLookupFunction extends TableFunction<RowData> {
    ...
    public RedisLookupFunction(
        ...
        Preconditions.checkArgument(
                redisCommand == HGET || redisCommand == GET,
